...
> 🤖 **Подход к работе:** активно использую генеративный ИИ как ассистента
> для ускорения рутины — генерации скриптов проверки (PowerShell,
> Python + Playwright), подготовки тестовых данных и краевых сценариев.
> При этом логику тестирования, анализ результатов и валидацию кода
> выполняю самостоятельно: ИИ пишет синтаксис, а QA-мышление
> и постановку задачи обеспечиваю я.
