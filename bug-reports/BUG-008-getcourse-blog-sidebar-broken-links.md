...
**Автотесты (Playwright + Chromium):**

- `tests/test_bug008_route_check.py` — HTTP-проверка 301-редиректа (5 ссылок × 3 проверки)
- `tests/test_bug008_e2e.py` — E2E-проверка клика по ссылке в sidebar (Playwright, 5 ссылок)
