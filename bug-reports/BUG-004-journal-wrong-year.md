...
- **Проект:** НКЭиВТ (образовательная платформа, электронный журнал)
- **Раздел:** Учебный процесс → Журналы
- **Тип бага:** UX / Отображение
- **Серьёзность:** Minor
- **Приоритет:** Low
- **Статус:** Reported (отправлен разработчикам)
- **Воспроизводимость:** Always
- **Дата обнаружения:** 12.01.2026
...
3. Проверить значение в поле выбора года
...
Баг-репорт был отправлен разработчикам
электронного журнала НКЭиВТ 12.01.2026.

Дефект подтверждён. Исправление запланировано.

Обратная связь от команды разработки: «Будем использовать ваш баг-репорт как пример правильного отчёта»
